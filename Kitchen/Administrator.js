...
$(".history-prevOrders-btn").on("click", () => {
  historyBtn = !historyBtn;
  document.querySelector(".history-prevOrders-btn").innerHTML = historyBtn
    ?"current Orders": "History";
  document.querySelector(".dashboard-desc").innerHTML = historyBtn
    ? "History"
    : "current Orders";


  if (historyBtn) getHistory();
  else getAllOrders();
});
...
function getAllOrders() {
  fetch(`http://${localhost}:${port}/allOrders`, {
    method: "GET", // or 'PUT'
    headers: {
      "Content-Type": "application/json",
    },
...
function getHistory() {
  fetch(`http://${localhost}:${port}/ordersHistory`, {
    method: "GET", // or 'PUT'
    headers: {
      "Content-Type": "application/json",
    },
